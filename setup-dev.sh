...
echo "2. Start HTTP backend: cd backend && python manage.py runserver 8000"
echo "3. Start WebSocket backend: cd backend && daphne -p 8001 onlineDebatePlatform.asgi:application"
echo "4. Start frontend: cd frontend && npm start"
echo ""
echo "🌐 HTTP Backend will be available at: http://localhost:8000"
echo "🌐 WebSocket Backend will be available at: ws://localhost:8001"
